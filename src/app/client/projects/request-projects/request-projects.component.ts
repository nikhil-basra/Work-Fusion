...
export class RequestProjectsComponent implements OnInit {
  ...
  navigateToUpdate(projectId: number): void {
    this.router.navigate(['client/update-requested-projects', projectId]);
  }
  ...
  deleteProject(projectId: number): void {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.clientService.deleteProjectRequest(projectId).subscribe({
          next: () => {
